...
int main(){
    ...
    Hrv2Module Hrv2Module(rPeaksModule);

    Hrv2Data results = Hrv2Module.getResults();
    
    /*tymczasowo wyswietlanie, zmienic na zapis do pliku*/
    cout << "Histogram values:" << "\n";
    for(int i =0; i<results.hist_values.size();i++){
        cout << results.hist_values[i] << " "; 
    }

    cout << "\n"<< "Bin centers:" << "\n";
    for(int i =0; i<results.bin_centers.size();i++){
        cout << results.bin_centers[i] << " "; 
    }
    cout << "\n" << "HRV index: " << results.hrv_index << "\n";
    cout << "Wskaznik TINN: " << results.tinn << "\n";
    cout << "SD1: " << results.SD1 << "\n";
    cout << "SD2: " << results.SD2 << "\n";
